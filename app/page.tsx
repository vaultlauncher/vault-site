...
export default function Home() {
  return (
    <div className="min-h-screen px-4">
      ...
      <p className="text-center text-base md:text-lg mt-4 max-w-2xl mx-auto text-secondary-foreground">
      ...
      <div className="mt-8 md:mt-12 flex justify-center">
        <Image
          ...
          className="rounded-lg shadow-lg w-full max-w-[800px] border border-muted"
        />
      </div>
      <Features />
    </div>
