...
export default function Home() {
  return (
    <div className="min-h-screen">
      <h1 className="text-6xl font-bold text-center w-2xl mx-auto mt-14">
        The <span className="text-primary">Ultimate</span> Game Launcher for{" "}
        <span className="text-chart-2">Steam Games</span>
      </h1>
      <p className="text-center text-lg mt-4 max-w-2xl mx-auto text-secondary-foreground">
      ...
      <div className=" gap-4 flex justify-center flex-col items-center">
        <div className="flex justify-center flex-row items-center mt-4 gap-4">
          <Button size="lg">
        ...
        <p className="text-muted-foreground text-xs">Linux support planned</p>
      </div>
      <div className="mt-5 flex justify-center">
        <Image
          ...
          className="rounded-lg shadow-lg w-[800px] border border-muted"
        />
      </div>
    </div>
  );
