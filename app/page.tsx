...
export default function Home() {
  return (
    <div className="min-h-screen px-4">
      ...
      <motion.h1
        className="text-4xl md:text-6xl font-bold text-center mx-auto mt-8 md:mt-8"
      ...
      <motion.p
        className="text-center text-base md:text-lg mt-4 max-w-2xl mx-auto text-secondary-foreground"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
